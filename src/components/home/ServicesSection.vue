  ...
  <section id="services" class="section-y bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center max-w-3xl mx-auto mb-14 anim-scroll">
        ...
        <h2 class="section-title font-display font-bold text-warm-900 mt-3 mb-4">{{ $t('services.title') }}</h2>
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
        <div
          ...
          :key="i"
          class="anim-scroll group card-hover fluid-panel flex h-full cursor-pointer flex-col rounded-lg p-6 hover:border-primary-200"
          :class="'delay-' + (i % 3 + 1)"
        ...
        >
          ...
          <p class="text-warm-500 text-sm leading-relaxed">{{ svc.displayDesc }}</p>
          <span class="mt-auto pt-5 inline-flex items-center gap-2 text-primary-600 text-sm font-semibold">
            {{ $t('nav.appointment') }}
